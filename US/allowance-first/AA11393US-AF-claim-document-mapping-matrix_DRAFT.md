...
1. **AF claims 1 and 20 are each scored as a whole in separate 20-document blocks.** A `P` means meaningful portions were identified, not that the complete system or method was found in the document. Claim 20 was independently reviewed; a parallel score is not presumed merely because its operations mirror claim 1.
