...
- **Numerical check:** 23 total / 3 independent / no multiple-dependent claim. The set exceeds the basic 20-total allocation by three claims; counsel must confirm ordinary excess-claim fees and all other filing requirements.
...
- **Continuation check:** Record every omitted supported family under [`CONT-03`](../common/AA11393US-continuation-preservation_MEMO.md).
