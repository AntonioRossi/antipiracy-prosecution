...
| Source | Filing date | Repository copy | Function in this map |
|---|---:|---|---|
...
| AF candidate set | 17.07.2026 draft | `AA11393US-AF-US_claim-set_DRAFT.md` | Proposed US allowance-first wording; not itself a support source |
...
| **G — express gate** | A material support, generalization, priority, or internal-consistency issue remains. | Do not file or rely materially on the feature until the identified counsel review is completed. |
...
## 3. AF claim 1 — limitation-level map
...
## 4. AF dependent claims — claim-by-claim map
...
## 5. Mandatory support and priority gates

### 5.1 Example 2 resynchronization inconsistency — AF claims 2–3
...
1. keep resynchronization out of AF claim 1;
...
### 5.2 Source-identity and same-region detection — AF claims 1 and 7–10
...
1. detecting the identities of both physical cameras on the respective sides of the suspect transition;
...
This is the most important AF claim 1 support gate. The limitation may be strategically justified against the art, but patentability value cannot substitute for written-description support. Counsel should consider whether the as-filed disclosure conveys source identity through EDL-referenced camera frames and the Example 5 visual comparison, and should preserve a support-safer alternative keyed to cut timing/version or reconstructed-manifest matching if not.

### 5.3 Examples 2–5 integration — AF claims 1, 7–10, and 13–18
...
### 5.4 Collusion wording — AF claims 11–12
...
## 7. Counsel verification checklist
...
4. Decide whether “temporally corresponding frames” is conveyed by synchronized multicamera feeds and Example 2, and whether the proposed first/second-camera generalization is commensurate with the concrete Camera 2→Camera 3 example.
5. Resolve the provisional Example 2 inconsistency before filing or materially relying on AF claims 2–3.
6. Determine whether Example 5 supports detection of camera-source identity on both sides of a transition or only visually similar frames, altered-cut characteristics, and timing.
7. Determine whether AF claim 1's candidate and detected pattern objects have an adequate operational basis, or substitute support-safer version/timing/reconstructed-manifest language.
8. Confirm the Examples 2→3→4 integration for AF claims 13 and 18 and the more specific paired-chunk geometry of AF claim 14.
9. Confirm AF claims 11–12's recipient-associated candidate-pattern input and portion-to-contributor wording; do not add attribution-score language absent an identified support basis.
10. Confirm the overlay/segmentation sequence in AF claim 19 or preserve a sequence-neutral version.
11. Review processor/instruction language, algorithm disclosure, § 112(f), definiteness, eligibility, and enablement independently of this written-description map.
12. Preserve the NA actor-focused claims as a portfolio option; adequate AF support would not resolve divided-infringement or proof concerns.

## 8. Intervening-information trigger
