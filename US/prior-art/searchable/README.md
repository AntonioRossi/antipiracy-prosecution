# US/prior-art/searchable — OCR'd Copies for Searching

> **DERIVED COPIES — NOT OFFICIAL COPIES AND NOT FOR FILING.**

The nine image-only PDFs from `../`, with a machine-generated OCR text layer added so they can be searched and text-selected in a PDF viewer. Generated 16.07.2026 with `ocrmypdf --skip-text --output-type pdf` (`--language eng`, or `chi_sim+eng` for B5 and B6).
