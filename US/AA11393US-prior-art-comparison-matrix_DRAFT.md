...
| **WO 2009/156973 A1 (B9, added 16.07.2026)** | Y: space-desynchronized streams | — | — | Y: sequential selection of consecutive segments across streams under one segmentation scheme | Y: per-user fingerprint | Y: fingerprint detection | P: spatial desynchronization only | Desynchronized-stream segment recombination was cited by the examiner against D1's family. No synchronized alternate-camera substitution at recorded cut boundaries. |
| **ETSI TS 104 002 V1.1.1, 2023-08 (C8, added 16.07.2026)** | Y: A/B watermarked variants | — | — | Y: standardized A/B delivery via edge/manifest with per-session variant sequences | Y: session-based recipient resolution | Y: extraction/recovery workflow | — | Standardization (08.2023) strengthens the obviousness backdrop for generic A/B claims. Independent claims must require camera-cut-derived variants. |
