...
| B9 | WO 2009/156973 A1 | 2009-12-30 | France Telecom SA (inventors Liu, Lian, Wang, Ren) | *Fingerprinting Method and System*; per-user version assembled by sequentially selecting consecutive segments from space-desynchronized streams under an identical segmentation scheme, with watermarks embedded in the selected segments; cited on the face of D1's US grant | Supplemental candidate identified 16.07.2026 from the D1-grant face-citation review; copy stored. Sibling WO 2009/122385 A2 (fingerprint encoding by watermark elimination) reviewed and provisionally set aside as cumulative of A2/C3 concepts — counsel to confirm both decisions |
...
- [ ] Review the 16.07.2026 supplemental references A6–A9, B9, C7, C8 for materiality against the final claim set and record submit/skip decisions; decide whether D1's grant US 11,540,029 B2 is listed in addition to A1.
