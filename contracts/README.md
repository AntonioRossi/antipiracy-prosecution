...
| 30 | [Navigator guide technical description](30-product-generation/navigator-guide/technical-description_DRAFT.md) / [acceptance criteria](30-product-generation/navigator-guide/acceptance-criteria_DRAFT.md) | Governs the shared on-load guide overlay, the persistent masthead reopen control, the no-JavaScript and print guide carriers, the two product-kind content profiles, and guide wording closure across all four HTML5 products. |
