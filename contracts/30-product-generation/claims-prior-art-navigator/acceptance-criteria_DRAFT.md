...
| **PA-AC-08** | product | Each interactive action leaves exact state and focus, one strong passage, related secondary passages, the mode-specific capable scroll owner, and unobscured target geometry; reduced motion is semantically identical. | navigator.lib.browserqa.browser_runtime; navigator.tests.test_prior_art.PriorArtNavigatorTests.test_pinned_browser_matrix_proves_runtime_layout_and_navigation |
