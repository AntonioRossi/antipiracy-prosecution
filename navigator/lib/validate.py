...
_BASE_WORDING = frozenset({
    ...
    "guide-control-close",
    "guide-dialog-title",
    "guide-glyph-candidate-previous",
    "guide-glyph-candidate-next",
    "guide-glyph-passage-previous",
    "guide-glyph-passage-next",
    "guide-glyph-move-previous",
    "guide-glyph-move-next",
    "guide-glyph-clear",
    "guide-profile-s-item-1",
    "guide-profile-s-item-2",
    "guide-profile-s-item-3",
    "guide-profile-s-item-4",
    "guide-profile-s-item-5",
    "guide-profile-s-item-6",
...
def validate_prior_art(model):
    ...
    try:
        ...
        expected_wording = {
            ...
            "guide-control-open", "guide-control-close",
            "guide-dialog-title",
            "guide-glyph-candidate-previous", "guide-glyph-candidate-next",
            "guide-glyph-passage-previous", "guide-glyph-passage-next",
            "guide-glyph-move-previous", "guide-glyph-move-next",
            "guide-glyph-clear",
            "guide-profile-p-item-1", "guide-profile-p-item-2",
            "guide-profile-p-item-3", "guide-profile-p-item-4",
            "guide-profile-p-item-5", "guide-profile-p-item-6",
            "guide-profile-p-item-7",
