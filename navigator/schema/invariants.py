...
def release_ready(owner_fields, expected_content_hash):
    ...
    lifecycle fields present, ``internally-reviewed``, ``current``, and a
    contentHash equal to the recomputed review-projection digest. Returns a
    list of defect strings (empty = ready)."""
    defects = []
